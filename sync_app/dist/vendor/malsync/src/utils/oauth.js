...
exports.oauth = oauth;
exports.clientId = '10093a3f9f0174b6b5577c40e9accdae';
function oauth() {
...
function generateUrl() {
    ...
    const url = `https://myanimelist.net/v1/oauth2/authorize?response_type=code&client_id=${exports.clientId}&state=${state}&code_challenge=${challenge}&code_challenge_method=plain`;
...
async function getRefreshToken() {
    ...
    return api.request
        ...
        data: `&client_id=${exports.clientId}&grant_type=authorization_code&code=${code}&code_verifier=${challenge}`,
    })
