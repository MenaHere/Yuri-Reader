        ...
        for (let i = 0; i < data.data.length; i++) {
            ...
            if (listType === 'anime') {
                tempData = await this.fn({
                    ...
                    image: el.attributes.posterImage && el.attributes.posterImage.small
                        ? el.attributes.posterImage.small
                        : '',
                    imageLarge: el.attributes.posterImage && el.attributes.posterImage.original
                        ? el.attributes.posterImage.original
                        : '',
                    imageBanner: el.attributes.coverImage && el.attributes.coverImage.large
