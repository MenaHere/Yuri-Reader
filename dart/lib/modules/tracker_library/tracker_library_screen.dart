...
import 'package:yuri_reader/modules/tracker_library/tracker_library_section.dart';
import 'package:yuri_reader/modules/tracker_library/tracker_section_screen.dart';
...
enum TrackerProviders {
  ...
  malsync(syncId: 6, name: "MAL-Sync");
          ...
          content: SingleChildScrollView(
            child: Column(
              children: [
                ...
                _getListile(l10n, TrackerProviders.malsync.syncId),
              ],
            ),
          ),
        );
