...
import 'package:yuri_reader/modules/more/about/providers/get_package_info.dart';
import 'package:yuri_reader/modules/more/about/providers/logs_state.dart';
                    ...
                    children: [
                      ...
                      SwitchListTile(
                        ...
                        onChanged: (value) async {
                          ref.read(logsStateProvider.notifier).set(value);
                          if (value) {
                      ...
                      ListTile(
                        onTap: () async {
                          try {
                            final info = await fetchLatestReleaseInfo();
                            if (context.mounted) {
                              showDialog(
                                context: context,
                                builder: (_) => DownloadFileScreen(
