...
class DownloadFileScreen extends ConsumerStatefulWidget {
  final (String, String, String, List<dynamic>, String) updateAvailable;
  final String? title;
  const DownloadFileScreen({required this.updateAvailable, this.title, super.key});
...
class _DownloadFileScreenState extends ConsumerState<DownloadFileScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 18),
              // Fork: upstream's latest release notes, wrapped in a collapsible.
              if (updateAvailable.$5.isNotEmpty) ...[
                Card(
                  ...
                  child: ExpansionTile(
                    ...
                    subtitle: const Text(
                      "What's new in the upstream app this release is based on",
  ...
  Future<void> _handleDownloadOrOpen(
    (String, String, String, List<dynamic>, String) updateAvailable,
  ) async {
