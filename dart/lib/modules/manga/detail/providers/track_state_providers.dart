...
import 'package:yuri_reader/services/trackers/anilist.dart';
import 'package:yuri_reader/services/trackers/base_tracker.dart';
import 'package:yuri_reader/services/trackers/kitsu.dart';
import 'package:yuri_reader/services/trackers/malsync.dart';
...
class TrackState extends _$TrackState {
  ...
  Future setTrackSearch(
    ...
    if (syncId == TrackerProviders.myAnimeList.syncId) {
      ...
      findManga = await tracker.findLibItem(newTrack, _isManga);
    } else if (syncId == TrackerProviders.malsync.syncId) {
      findManga = await tracker.update(newTrack, _isManga);
    }
    writeBack(findManga!);
  }
